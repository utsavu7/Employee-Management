...
<html lang="en">
    <head>
        ...
        <link type="text/css" rel="stylesheet" href="assets/plugins/materialize/css/new.css"/>
    ...
    <body>
        ...
        <h4 class="font-weight-bold text-center text-danger">Employee Leave Management</h4>
                                       ...
                                       <div class="row">
                                           <form class="col col-md-12 " name="signin" method="post">
                                               ...
                                               <div class="col col-md-12 center m-t-sm">
                                                  ...
                                                  <a class="waves-effect waves-grey" href="forgot-password.php" style="margin-bottom: 10px; margin-left: 10px;">Employee Password Recovery?</a>
                                               </div>
                                           </form>
                                      </div>
                                  </div>
