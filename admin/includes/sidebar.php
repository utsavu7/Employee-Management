     <aside id="slide-out" class="side-nav white fixed">
                <div class="side-nav-wrapper">
                    <div class="sidebar-profile">
                        <div style="padding:0px;position:relative;top:-30px"> <!-- ADD THESE CODES TO CSS FILE -->
                            <center>
                            <p><a target="__blank" href="https://jssateb.ac.in/"><img src="../assets/images/jss.png" width="100%"></a></p>
                        </center>
                        </div>
                ...
                <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion" style="padding:0px!important;">
